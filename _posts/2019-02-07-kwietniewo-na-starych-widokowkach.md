...
{% include figure
    ...
    alt='Gruss aus Blumenau strona adresowa'
...
{% include figure
    ...
    alt='Zielone centrum Blumenau'
    caption='Rys. 12.3. Zielone centrum Blumenau'
%}
...
{% include figure
    ...
    alt='Gruss aus Kgl. Blumenau'
    caption='Rys. 12.5. "Gruss aus Kgl. Blumenau, Ostpr."'
%}
...
{% include figure
    ...
    alt='Adresat i nadawca pocztówki z 1908 roku'
...
{% include figure
    ...
    alt='Rewers zimowej kartki'
    caption='Rys. 12.8. Rewers "zimowej" kartki'
%}
...
{% include figure
    image_path='/assets/images/widokowki/12_9a.jpg'
    alt='Zaginiona pocztówka z 1924 roku'
    caption='Rys. 12.9a. Zaginiona pocztówka z 1924 roku'
%}

{% include figure
    image_path='/assets/images/widokowki/12_9b.jpg'
    alt='Rewers zaginionej pocztówki z 1924 roku'
...
{% include figure
    ...
    alt='Kwietniewo na widokówce sprzed 1933 roku'
...
{% include figure
    ...
    alt='Widoki przedwojennego Kwietniewa na kartce pocztowej wydanej po 1933 roku'
...
{% include figure
    ...
    alt='Dom sołtysa Paula Fähndricha w stylu włoskiej willi'
...
{% include figure
    image_path='/assets/images/widokowki/12_17.jpg'
    alt='Atrakcje turystyczne gminy Rychliki'
    caption='Rys. 12.17. Atrakcje turystyczne gminy Rychliki: pochylnia w Buczyńcu, żyzne łany nad Dzierzgonką, widok Kwietniewa z drogi na Św. Gaj i kościół w Rychlikach z wieżą jak ołówek'
%}
...
{% include figure
    image_path='/assets/images/widokowki/12_18.jpg'
    alt='Kartka świąteczna parafii Kwietniewo'
    caption='Rys. 12.18. Kartka świąteczna parafii Kwietniewo'
%}
